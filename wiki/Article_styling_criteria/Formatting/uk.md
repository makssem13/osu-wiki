...
*Примітка: osu! wiki показує версію статті на мові, выбраній у налаштуваннях сайта. Якщо переклада не існує, буде показано англійську версію.*
...
| `fi.md` | Фінська | Suomi |
| `fil.md` | Філіппінска | Wikang Filipino |
